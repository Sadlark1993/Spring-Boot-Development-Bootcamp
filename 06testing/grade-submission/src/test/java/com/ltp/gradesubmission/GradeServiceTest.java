...
public class GradeServiceTest {
  ...
  public void getGradesFromRepoTest(){
    when(gradeRepository.getGrades()).thenReturn(Arrays.asList( //setting the mock data
      new Grade("Harry", "Potions", "C-"),
      new Grade("Hermione", "Arithmancy", "A+")
    ));

    List<Grade> result = gradeService.getGrades(); // calling the method that we want to test

    //check if the method is behaving correctly
